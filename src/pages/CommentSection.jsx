...
function CommentSection({
    ...
    return (
        <div className=''>
            <div className={`bg-[#31363F] w-[90%] md:w-[80%] lg:w-[30%] h-[4rem] fixed lg:top-[50%] lg:right-[0]  bottom-0 z-10 mx-5 flex items-center justify-center py-5 shadow-xl rounded-t-2xl`}>
                <div>
