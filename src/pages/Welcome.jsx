...
<div className="basis-2/4 h-[35rem] xl:h-[25rem]  lg:flex flex-col gap-3">
  <div className='basis-1/3 bg-white text-black rounded-[1rem] pt-2 pl-3 pb-2 shadow-2xl'>
    ...
    <div>
      <img style={{height:'50px'}} src="https://img.freepik.com/free-photo/3d-illustration-cartoon-female-tourist-with-camera_1142-32317.jpg?t=st=1713258403~exp=1713262003~hmac=40049ffdfe6e43796fc517fe880d3bad4d055e48e00946120ef1431cc510c8f7&w=740" alt="" />
       </div>
    <div> 
      Hey there, you can call me <b >TESSY</b>, I'm a passionate blogger
      waiting to share with you and also learn from you❤️.
    </div>
  ...
  <div  className='basis-1/3 bg-indigo-400 rounded-[1rem] '>hello</div>

</div>
<div className="basis-2/4 h-[35rem] xl:h-[25rem] rounded-[1rem] flex flex-row gap-4 ">

<div className='basis-1/2  gap-3 flex flex-col'>
  <div className='basis-1/3 bg-red-400 rounded-[1rem] '>hello</div>
  <div className='basis-2/3 bg-green-500 rounded-[1rem] ' >
    <div>
      <img src="
      https://www.canva.com/design/DAGCk8fRmc4/_AJUAgMUoTnPTX6NLVYL7w/view
...
<div className='basis-1/2 flex gap-3 flex-col'>
  <div className='basis-2/3 bg-green-500 rounded-[1rem] ' >hello</div>
<div className='basis-1/3 bg-red-400 rounded-[1rem] '>hello</div>
