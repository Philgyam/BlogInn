...
function FullPost() {
    ...
    return (
        <>
            ...
            {showComments && (
                <div className=''>
                    <div className={`bg-[#31363F] w-[90%] h-[4rem] fixed bottom-0 z-5 mx-5 flex items-center justify-center py-5 transition shadow-xl duration-1000ms ease-out sticky-bottom rounded-t-2xl`}>
                        <div className=''>
